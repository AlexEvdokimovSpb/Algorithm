public class HashTable {
    ...
    public int hashFuncDouble(int key) { // для алгоритма двойного хеширования
        return 5 - key % 5;
    }
    ...
    public void insert(Item item) {
        ...
        int stepSize = hashFuncDouble(key); // для алгоритма двойного хеширования
        while (hashArr[hashVal] != null && hashArr[hashVal].getKey() != -1) {
            // ++hashVal; // вариант с линейным пробированием
            hashVal += stepSize; // для алгоритма двойного хеширования
            if (hashVal == arrSize) {
            return;
            }
        }
